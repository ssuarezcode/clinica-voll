...
class MedicoRepositoryTest {
    ...
    void seleccionarMedicoConEspecialidadEnFechaEscenario1() {
        ...
        var medico=registrarMedico("Jose","j@mail.com","553322",Especialidad.PSIQUIATRIA);
        var paciente= registrarPaciente("antonio","a@mail.com","664422");
        registrarConsulta(medico,paciente,proximoLunes10H);

        //when
        var medicoLibre = medicoRepository.seleccionarMedicoConEspecialidadEnFecha(Especialidad.DERMATOLOGIA,proximoLunes10H);
    ...
    void seleccionarMedicoConEspecialidadEnFechaEscenario2() {
        ...
        var medico=registrarMedico("Jose","j@mail.com","126455",Especialidad.ORTOPEDIA);
